...
class SteerLimitParams:
  STEER_MAX = 1500   # 409 is the max, 255 is stock
  STEER_DELTA_UP = 5
  STEER_DELTA_DOWN = 7
...
FEATURES = {
  ...
  "use_elect_gears": [CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.KIA_NIRO_EV], # Use TCU Message for Gear Selection
# these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": [CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.KONA, CAR.KONA_EV, CAR.KIA_FORTE, CAR.PALISADE, CAR.KIA_NIRO_EV],

  "use_bsm": [CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KIA_NIRO_EV],
}

EV_HYBRID = [CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV]
