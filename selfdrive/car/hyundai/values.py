...
class SteerLimitParams:
  STEER_MAX = 399   # 409 is the max, 255 is stock
  STEER_DELTA_UP = 5
  STEER_DELTA_DOWN = 7
...
FEATURES = {
  ...
  "use_bsm": set([CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA, CAR.KIA_NIRO_EV]),
}
